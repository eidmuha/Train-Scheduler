...
function updateFirebase(newValues, data_edit){
  ...
  var data = {trainname:newValues.name, destination:newValues.dest, trainFrequency:newValues.tfreq, firstTrainTime:newValues.arival}
...
$().ready(function () {
  ...
  trainDetail.on("child_added", function (snapshot) {
    updateTable(snapshot.val().trainname, snapshot.val().destination, snapshot.val().firstTrainTime, snapshot.val().trainFrequency, snapshot.ref.key);
  });
  ...
  function updateTable(trainname, destination, firstTrainTime, trainFrequency, key) {    
    ...
    var del = '<button class="delBtn" data-delete = ' + key + '><i class="fa fa-trash-o"></i></button>';
    var safe = '<button class="safeBtn" data-edit = ' + key + '>&#10004;</button>';
    ...
    var newRow = $("<tr>").append(
      $("<td>").html("<div class='row_data' edit_type='click' col_name='name'>"+trainname+"</div>"),
      $("<td>").html("<div class='row_data' edit_type='click' col_name='dest'>"+destination+"</div>"),
      // $("<td>").text(firstTrainTime),
      $("<td>").html("<div class='row_data' edit_type='click' col_name='tfreq'>"+trainFrequency+"</div>"),
      $("<td>").html("<div class='row_data' edit_type='click' col_name='arival'>"+nextArival+"</div>"),
      $("<td>").html("<div class='row_data' edit_type='click' col_name='nextTrain'>"+tMinutesTillTrain+"</div>"),
      $("<td>").html(edit + " " + del),
      $("<td>").html(safe + " " + canCel),
